...
class FunctionAdmisionAlumnos
{
    ...
    public static function getBotonesAdmisionAlumnos($codAdmisionAlumno, $estadoAdmisionAlumno)
    {
        if ($estadoAdmisionAlumno == 1) {
            $botones = '
        <button type="button" class="btn btn-warning btnVisualizarAdmisionAlumno" codAdAlumCalendario="' . ($codAdmisionAlumno) . '" data-bs-toggle="modal" data-bs-target="#calendarioAdmisionPago" disabled><i class="bi bi-calendar-week"></i></button>
      ...
      ';
        ...
        if ($estadoAdmisionAlumno == 2) {
            $botones = '
             <button type="button" class="btn btn-warning btnVisualizarAdmisionAlumno" codAdAlumCalendario="' . ($codAdmisionAlumno) . '" data-bs-toggle="modal" data-bs-target="#calendarioAdmisionPago"><i class="bi bi-calendar-week"></i></button>
