...
//  registrar  a postulante en admision 
  public static function mdlCreateAdmisionPostulate($table, $dataPostulanteAdmicion)
  {
    $statement = Connection::conn()->prepare("INSERT INTO $table (idAnioEscolar, idPostulante, fechaAdmision, fechaCreacion, fechaActualizacion, usuarioCreacion, usuarioActualizacion) VALUES (:idAnioEscolar, :idPostulante, :fechaAdmision, :fechaCreacion, :fechaActualizacion, :usuarioCreacion, :usuarioActualizacion)");
