$("#dataTableAlumnosDocente").on("click", ".btnVisualizarNotas", function () {
  var codAlumno = $(this).attr("idAlumno");
  ...
  var tableCursosPorGrado = $("#dataTableNotasPorAlumnoDocenteVisualizar").DataTable({
  ...
  $("#dataTableNotasPorAlumnoDocenteVisualizar thead").html(`
            <tr>
...
$("#modalNotasAlumnoDocente").on("click", "#btnImprimirPDFVisualizarDocente", function () {
