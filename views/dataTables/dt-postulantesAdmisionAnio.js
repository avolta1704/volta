...
$(document).ready(function () {
  ...
  var tablePostulantesReport = $("#dataTablePostulantesReporteAnio").DataTable({
    columns: columnDefsPostulantesReport,
  });

  // Titulo dataTablePostulantesReporteAnio
  $(".tituloPostulantesReportAnio").text("Reporte Todos los Postulantes Registrados Anual y Mensualmente");
