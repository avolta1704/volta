  ...
  $.ajax({
    ...
    success: function (response) {
      if (response == "sin criterios") {
        ...
        const dataAlumnosConNotas = Object.values(response.alumnosConNotas);
              ...
              competencia.criterios.map((criterio) => {
                return {
                  ...
                  render: function (data, type, row) {
                    const idCompetencia = competencia.idCompetencia;
                    const idCriterio = criterio.idCriterioCompetencia;
