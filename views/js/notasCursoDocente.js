...
$(document).ready(function () {
  ...
  if (ruta && idCurso && idGrado && idPersonal) {
    ...
    $("#modalDuplicarCompetencia")
      ...
      .on("click", "#btnDuplicarCompetenciaModal", function () {
        ...
        selectedCheckboxes.each(function () {
          const dataCompetencia = {
            descripcionCompetenciaCrear: $(this).next("label").text(),
            idCompetencia: $(this).next("label").attr("idCompetencia"),
          };
...
$("#dataTableCriteriosCompetencias").on(
  ...
  function () {
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (idTecnicaEdit == idTecnica) {
                $("#selectInstrumentosEditar").val(idInstrumento);
              } else {
                // Si no se selecciona el primer instrumento
                $("#selectInstrumentosEditar").val(
                  $("#selectInstrumentosEditar option:first").val()
                );
              }
            },
            error: function (jqXHR, textStatus, errorThrown) {
    ...
    $("#modalEditarCriterio").on("click", "#btnGuardarCriterio", function () {
